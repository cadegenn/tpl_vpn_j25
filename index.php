...
<body>
	<?php // analytics
		// google analytics, now Universal Analytics
		if ($this->params->get('google-analytics') != '') : ?>
			<script>
				...
				ga('create', '<?php echo $this->params->get('ga-userid'); ?>', '<?php echo $this->params->get('ga-site'); ?>');
				ga('send', 'pageview');
			</script>
		<?php endif; ?>

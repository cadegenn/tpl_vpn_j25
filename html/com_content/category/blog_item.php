...
<?php   $useDefList = (($params->get('show_author')) or ($params->get('show_category')) or ($params->get('show_parent_category'))
        ...
        $articleIconsDisplay = ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon') || $useDefList); ?>
<div class="article-icons-blog article-icons-display-<?php echo ($articleIconsDisplay ? "true" : "false"); ?>">
